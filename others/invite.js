...
module.exports = {
  ...
  execute(message, args, client) {
    ...
    message.reply(new MessageEmbed().setColor("#2aa200").setTitle("Power bot  Invite ✨").setDescription("✔️ **[Click Here](https://discord.com/api/oauth2/authorize?client_id=866028690915590164&permissions=8&scope=bot) to invite the bot.**")
